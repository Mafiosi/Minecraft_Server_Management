...
def main():
    ...
    while True:
        ...
        try:
            ...
            server.put('D:\Projects\Minecraft_Server_Management\Source_Code\Internal_MManager.py','/opt/scripts')
            print("Files Were Transfered Successfully!")
            break
        except:
            print("Couldn't Transfer Files, Check Connection.")
            break
