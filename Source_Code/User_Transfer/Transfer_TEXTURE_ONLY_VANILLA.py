...
def starting_module(c_q):
    ...
    while True:
        ...
        print("[SPECIFICATIONS] Folder: Textures_Only_Vanilla.zip   Size: 41 MB   ETA: 1-3 min")
        print("[CONTENTS]   4 - TEXTURES")
        print()
        ...
        while answer not in ("y", "n"):
            ...
            if answer == "y" or answer == "yes":
                try:
                    ...
                    server.get('/opt/Transfer/Vanilla/Distribution/Textures_Only_Vanilla.zip', None, True)
