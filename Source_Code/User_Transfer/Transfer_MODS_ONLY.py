...
def starting_module(c_q):
    ...
    while True:
        ...
        print("[SPECIFICATIONS] Folder: MODS_ONLY.zip   Size: 88 MB   ETA: 1-3 min")
        print("[CONTENTS]   1 - MODS")
        print()
        ...
        while answer not in ("y", "n"):
            ...
            if answer == "y" or answer == "yes":
                try:
                    ...
                    server.get('/opt/Transfer/Modded/Distribution/Mods_Only.zip', None, True)
